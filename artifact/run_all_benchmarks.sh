...
python3 scripts/generate_sim_experiments.py qasm/mqtbench_indep/ --name fig1c --max_qubits 30 --test_norm_strats
...
# Figure 2
printf "\n\nFigure 2\n"
python3 scripts/generate_sim_experiments.py qasm/mqtbench_indep/ --name fig2a --max_qubits 50
...
printf "\n\nFigure 2 + validation\n"
python3 scripts/generate_sim_experiments.py qasm/mqtbench_indep/ --name fig2a_val --max_qubits 20 --log_vector
bash experiments/fig2a_val/run_all.sh
python3 scripts/process_results.py experiments/fig2a_val/ --compare_vecs

python3 scripts/generate_sim_experiments.py qasm/ketgpt/ --name fig2b_val --max_qubits 20 --log_vector
...
# Figure 3
printf "\n\nFigure 3\n"
python3 scripts/generate_sim_experiments.py qasm/mqtbench_indep/ --name fig3_left --max_qubits 50 --workers 1 8 64
bash experiments/fig3_left/run_qsylvan.sh
python3 scripts/process_results.py experiments/fig3_left/

python3 scripts/generate_sim_experiments.py qasm/ketgpt/ --name fig3_right --workers 1 8 64
...
# Table 2 (appendix)
printf "\n\nTable 2 (appendix)\n"
python3 scripts/generate_sim_experiments.py qasm/mqtbench_ibm/ --name tab2 --nqubits 8 16 32 --tools q-sylvan mqt quasimodo
...
printf "\n\nTable 3 + 4 + 5 + 6\n"
python3 scripts/generate_eqcheck_experiments.py qasm/equivalence/ --name tabs_eqcheck
