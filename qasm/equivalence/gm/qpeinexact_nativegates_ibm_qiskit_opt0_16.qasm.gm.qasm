...
cz q[12], q[0];
cx q[1], q[12];
rz(1.861328125*pi) q[12];
rz(0.72265625*pi) q[1];
h q[12];
h q[1];
h q[8];
h q[6];
...
cz q[0], q[5];
cz q[0], q[1];
rz(1.9286041259765625*pi) q[15];
rz(1.0714263916015625*pi) q[14];
h q[14];
rz(1.75*pi) q[13];
rz(1.625*pi) q[12];
rz(1.5625*pi) q[11];
